...
RemindCore Next is the Phase 5 scratch-trained understanding extension for the
always-installed planner. It learns four bounded tasks from the Phase 4
AssistantPlan corpus: coarse route, ordered capability clauses, action count,
and whether a turn needs dialogue context.
...
The promoted profile uses 8,192 buckets, project signals, typed context, and no
